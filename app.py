...
def load_model(model_file):
    ...
    return mmm, media_scaler, target_scaler, prices, media_names, media_list, plot1, plot2
...
if model_file is not None:
    with st.spinner("Loading model..."):
        try:
            mmm, media_scaler, target_scaler, prices, media_names, media_list, plot1, plot2 = load_model(model_file)
